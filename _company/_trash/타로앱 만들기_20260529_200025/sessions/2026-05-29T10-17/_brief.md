...
## 요약
타로앱 만들기 프로젝트 재시작: 데이터 수집부터 사이트 구현까지 처음부터 다시 진행

## 분배
- **🔍 Researcher**: 타로카드 78장(메이저 아르카나 22장 + 마이너 아르카나 56장) 각각에 대해 카드 이름, 정방향(upright) 의미 2~3문장, 역방향(reversed) 의미 2~3문장, 관련 키워드 5개 이상을 수집하여 /Users/kks/Desktop/kks/_company/projects/타로앱 만들기/_shared/tarot_data.md 파일에 마크다운 테이블 형식으로 저장하세요. 모든 카드는 빠짐없이 포함해야 하며, 정방향/역방향 의미는 구체적이고 실용적인 해석으로 작성하세요.
